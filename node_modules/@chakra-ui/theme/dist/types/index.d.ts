...
export declare const theme: {
    components: {
        ...
        Breadcrumb: {
            ...
            baseStyle: Partial<Record<"link" | "item" | "separator", import("@chakra-ui/styled-system").RecursiveCSSObject<import("@chakra-ui/styled-system").CSSWithMultiValues>>>;
        };
        Button: {
        ...
        Checkbox: {
            ...
            baseStyle: import("@chakra-ui/theme-tools").PartsStyleFunction<Pick<import("@chakra-ui/theme-tools").Anatomy<"icon" | "label" | "control">, "extend" | "selectors" | "classNames" | "keys" | "toPart" | "__type">>;
            sizes: Record<string, Partial<Record<"icon" | "label" | "control", import("@chakra-ui/styled-system").RecursiveCSSObject<import("@chakra-ui/styled-system").CSSWithMultiValues>>>>;
            defaultProps: {
                size: string;
                colorScheme: string;
            };
